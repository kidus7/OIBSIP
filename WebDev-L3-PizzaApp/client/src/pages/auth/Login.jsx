    ...
    <div className="min-h-screen h-full w-full bg-slate-950 text-white grid grid-cols-1 lg:grid-cols-12 p-4 sm:p-6 overflow-y-auto">
      ...
      <div className="hidden lg:flex lg:col-span-7 relative overflow-hidden items-center justify-center p-12 rounded-3xl m-2">
        <div 
          ...
          style={{ backgroundImage: `url('https://images.unsplash.com/photo-1513104890138-7c749659a591?q=80&w=1920&auto=format&fit=crop')` }}
        />
        ...
        <div className="relative z-10 max-w-lg backdrop-blur-md bg-white/10 border border-white/20 p-8 rounded-2xl shadow-2xl">
          <div className="flex items-center space-x-3 mb-4">
            ...
            <div>
              <span className="text-xs uppercase tracking-wider text-red-400 font-bold px-2.5 py-1 bg-red-500/10 rounded-full border border-red-500/20">
                SliceMaster Portal
              </span>
              <h1 className="text-2xl font-extrabold mt-1 text-white">Welcome Back, Foodie!</h1>
            </div>
          </div>
          <p className="text-slate-300 text-sm leading-relaxed mb-6">
            Artisan Hand-Crafted Pizzas • Live Real-Time Delivery Tracking 🛵. Experience piping hot, freshly baked gourmet pizzas delivered straight to your doorstep with lightning speed.
          </p>
